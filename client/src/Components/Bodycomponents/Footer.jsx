            ...
            <div className="bg-[#f8f8f8] mt-10">
                <div className="container mx-auto p-6">
                    <div className="grid lg:grid-cols-4 gap-6">
                        <div className="">
                            <h1 className="font-sans font-bold text-3xl">Go <span className='text-xl font-semibold font-sans'>Wheelz</span></h1>
                            ...
                            <h2 style={{cursor:"pointer"}} className="font-sans font-bold text-lg my-1 hover:text-orange"><PhoneIcon/>08951179896</h2>
                            <h2 style={{cursor:"pointer"}} className="font-sans font-bold text-lg my-1 hover:text-orange"><EmailIcon/> gowheelz@gmail.com</h2>
                            <h2 style={{cursor:"pointer"}} className="font-sans text-lg my-1 hover:text-orange">Design by DevCore</h2>
                        </div>
                        <div className="">
                            <h2 className="font-sans font-bold text-2xl">COMPANY</h2>
                            <p style={{cursor:"pointer"}} className="font-sans text-lg mt-1 hover:text-orange">Bengaluru</p>
